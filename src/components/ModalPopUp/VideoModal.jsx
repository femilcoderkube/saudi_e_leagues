...
function VideoModal({ onClose }) {
  ...
  return (
    ...
    >
      <div
        className={`bg-[#121331] rounded-2xl p-2 md:p-6 w-[90dvh] md:w-[70dvh] h-[50%] relative overflow-hidden shadow-2xl flex flex-col items-center justify-center transform transition-all duration-300 ${
