...
const GameCardSlider = () => {
  ...
  // const { ongoingLeaguesAndTournaments } = useSelector((state) => state.games);
  // const BASE_IMAGE_URL = "https://backend.primeeleague.com/api/v1/";

  // const cardsToDisplay = ongoingLeaguesAndTournaments.length > 0
  ...
  // useEffect(() => {
  //   dispatch(fetchOngoingLeaguesAndTournaments());
  // }, [dispatch]);
