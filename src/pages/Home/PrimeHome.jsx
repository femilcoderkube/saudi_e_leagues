...
export default function PrimeHome() {
  ...
  return (
   ...
   <div className="main_con--bg absolute top-0 left-0 h-full bg-no-repeat" style={{backgroundSize:'auto'}}></div>
     ...
     <div className="sd_home-wrapper ">
       ...
       <section className="home_hero--sec flex pt-[21.125rem] justify-between items-end">
         ...
         <div className="home_hero_left-con h-full flex justify-end flex-col">
           ...
           <h1 className="flex text-[4rem] gap-3 uppercase leading-none mb-2 items-center tracking-wide !font-black">
             Your Game - 
             <span className="text-[1.75rem] leading-none"> Join <br/>Epic</span>
           </h1>
         ...
         <div className="home_hero_right-con h-full relative">
             <div className="slider_header--con  pb-[2.2rem] inline-block">
               <h3 className="purple_col text-lg !font-black leading-none text-right uppercase">Choose your</h3>
       ...
       <section className="home_about--sec pt-[7.5rem] pb-[5rem]  flex overflow-hidden">
         <div className="about_left--con max-w-[45%]">
           <h3 className="text-[2.375rem] uppercase !font-black mb-5">About</h3>
           <img src={Primetxt} alt="" style={{width:'42.5rem'}} />
           <div className="about-con">
             <h4 className="purple_light text-2xl pb-5 !font-semibold mt-[-1rem]"><span className="uppercase !font-bold sky_col">Prime </span> is where skill meets purpose.</h4>
             <p className="text-xl purple_col mb-12">Born from the heart of the grassroots scene, Prime is not just a league — it’s a living system designed to reward dedication, amplify visibility,
               and connect ambitious players through real, meaningful competition.</p>
             <h4 className="purple_light text-2xl pb-5 !font-semibold">In <span className="uppercase !font-bold sky_col">Prime </span> you don’t just play — you grind.</h4>
             <p className="text-xl purple_col">Every match is a step forward. Every queue is a shot at growth. Every match builds your story. Whether you're playing solo or as part of a squad, PRIME creates the space for authentic connection and continuous competition.</p>
             <h4 className="purple_light text-2xl pb-5 !font-semibold mt-10">This is where grassroots players rise to their prime!</h4>
           </div>
         </div>
           ...
           <div className="sd_play-link relative sd_before before:w-full before:h-full flex flex-col items-center h-full justify-center">
             <Link
               ...
               >            
                   ...
                   <span className="text-2xl font-semibold purple_col">Whatch the Video</span>                     
             </Link>
           </div>
         </div>              
       </section>
       ...
       <section className="htp_slider-sec flex justify-between ">
         ...
         <div className="htp_left-con h-full flex justify-end flex-col max-w-[30%]">
           <h2 className="grad_head--txt max-w-full text-[5rem] tracking-wide !font-black leading-none uppercase">How</h2>
           <h2 className="text-[4rem] mt-[-1rem] grad_text-clip uppercase leading-none items-center tracking-wider !font-black pb-10">
             to Play?                  
           </h2>
           <p className="htp_content block purple_col sd_before relative before:w-full before:top-0 text-2xl font-semibold py-10 pr-3">Pellentesque dictum porta, lacinia molestie ante maximus at</p>
