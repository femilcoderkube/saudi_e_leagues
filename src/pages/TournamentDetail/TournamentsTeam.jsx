...
//                   <h3 className="md:text-2xl text-lg font-bold text-[#F4F7FF]">
//                     Team Falcons
//                   </h3>
  ...
  return (
    <>
      ...
      <div className="team-main-user mt-16">
        <div className="team-user-title flex items-center justify-between mb-10">
          <h3 className="grad_text-clip !font-extrabold uppercase text-[2rem] bg-[linear-gradient(181.21deg,rgba(132,146,180,0.8)_1.03%,rgba(132,146,180,0.16)_98.97%)]">
            Overwatch Roaster
          </h3>
          <div className="btn_polygon--mask sm:inline-flex hidden max-w-[fit-content] justify-center sd_before sd_after relative polygon_border hover:opacity-70 duration-400 ">
            ...
            <div className="game_card--roaster-main flex flex-col justify-between relative mt-[-25px]">
              <div className="game_card--roaster-wrap">
                <div className="flex justify-end w-full">
                  <img src="/src/assets/images/menu_roaster.svg" alt="" />
                </div>
              ...
              <div className="flex justify-between items-center border-t-[1px] border-[#5E73B880] px-7 py-[9.5px] mb-2">
                ...
                <img src="/src/assets/images/roaster-arrow.svg" alt="" />
              </div>
            </div>
          </div>
          <div className="flex flex-col max-w-max align-center justify-center">
