      ...
      <div className="w-[32rem] md:mb-[2.4rem]">
        ...
        >
          {starOfTheWeekData.map((star, index) => {
            let isYourPoints =
              star?.weeklyUsersData?.userId?._id.toString() !=
                star?.requestedUsersScore?.userId.toString() && user?._id;
            return (
                  ...
                  <div className="profile-wp flex items-center justify-between gap-3">
                    ...
                    <div className="sd_score--con pr-2">
                      <h2 className="text-[1.2rem] !font-extrabold grad_text-clip pb-2 ltr:text-right rtl:text-left">
                        {(star?.weeklyUsersData?.weeklyScore < 0
                          ? 0
                          : star?.weeklyUsersData?.weeklyScore
                        )?.toString()}
                      </h2>
